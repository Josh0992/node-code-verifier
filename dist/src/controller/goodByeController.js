...
let goodByeController = class goodByeController {
    /**
...
], goodByeController.prototype, "getMessageDate", null);
goodByeController = __decorate([
    (0, tsoa_1.Route)('/api/bye'),
    (0, tsoa_1.Tags)('goodByeController')
], goodByeController);
